...
const Forecast = ({ data }: Props): JSX.Element => {
  ...
  return (
    <div className="w-full md:max-w-[500px] p-4 md:py-4 md:px-10 lg:px-24 h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-ls rounded drop-shadow-lg text-stone-100">
      <div className="mx-auto w-[300px]">
        ...
        <section className="flex flex-wrap justify-between text-stone-100">
